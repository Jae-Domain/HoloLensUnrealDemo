...
template<> UXTOOLS_API UScriptStruct* StaticStruct<FUxtButtonBrush>()
{
	...
	struct Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtButtonBrush_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtButtonBrush_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtButtonBrush_h_716306423(TEXT("/Script/UXTools"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtButtonBrush_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtButtonBrush_h_Statics::ScriptStructInfo),
		nullptr, 0);
