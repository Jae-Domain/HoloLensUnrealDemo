...
template<> XRSIMULATION_API UScriptStruct* StaticStruct<FXRSimulationHandPoseKeyMapping>()
{
	...
	struct Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_1201403685(TEXT("/Script/XRSimulation"),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_XRSimulation_Public_XRSimulationRuntimeSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
