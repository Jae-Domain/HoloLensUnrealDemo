...
template<> UXTOOLS_API UScriptStruct* StaticStruct<FUxtAffordanceConfig>()
{
	...
	struct Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_1639844223(TEXT("/Script/UXTools"),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Public_Controls_UxtBoundsControlConfig_h_Statics::EnumInfo));
