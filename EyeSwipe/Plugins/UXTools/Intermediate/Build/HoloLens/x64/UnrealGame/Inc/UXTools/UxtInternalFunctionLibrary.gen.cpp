...
template<> UXTOOLS_API UScriptStruct* StaticStruct<FUxtFontCharacter>()
{
	...
	struct Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_2704646288(TEXT("/Script/UXTools"),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EyeSwipe_Plugins_UXTools_Source_UXTools_Private_Utils_UxtInternalFunctionLibrary_h_Statics::ScriptStructInfo),
		nullptr, 0);
